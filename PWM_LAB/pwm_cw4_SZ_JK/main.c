...
void lcd_update(void) {
	...
	LCD1602_PrintNum((int)(1.0f/TPM1_GetPeriod())); // ToDo 2.5: Enable to see result on LCD
}

float TPM1_GetPeriod()
{
	return (float)TPM1_GetVal() * 16.0f / 3000000.0f;
}
